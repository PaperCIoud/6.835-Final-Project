	...
	void Update()
	{
		if(KinectInitialized)
		{
			...
			if(Player1Calibrated)
			{
				...
				//make a copy of list to prevent runtime errors with threads
				List<KinectGestures.GestureData> player1GesturesViewable = new List<KinectGestures.GestureData>(player1Gestures);
				foreach(KinectGestures.GestureData gestureData in player1GesturesViewable)
				{
